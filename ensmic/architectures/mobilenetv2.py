...
Methods:
    ...
    create_model_2D:        Creating the 2D MobileNetV2 model for classification
    create_model_3D:        -
"""
class Architecture_MobileNetV2(Abstract_Architecture):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    ...
    def create_model_2D(self, input_shape, n_labels=2):
        ...
        base_model = MobileNetV2(include_top=False, weights=self.weights,
                                 input_tensor=None,
