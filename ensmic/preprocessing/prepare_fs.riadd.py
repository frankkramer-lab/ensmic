...
path_mapclass = os.path.join(path_input, "Training_Set",
...
input_img_dir = os.path.join(path_input, "Training_Set", "Training")
for img in os.listdir(input_img_dir):
    ...
    class_dict[name] = int(class_map[int(img[:-4])])
    # Increment index
    i += 1
