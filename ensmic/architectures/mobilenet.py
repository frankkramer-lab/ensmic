...
Methods:
    ...
    create_model_2D:        Creating the 2D MobileNet model for classification
    create_model_3D:        -
"""
class Architecture_MobileNet(Abstract_Architecture):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    ...
    def create_model_2D(self, input_shape, n_labels=2):
        ...
        base_model = MobileNet(include_top=False, weights=self.weights,
                               input_tensor=None,
