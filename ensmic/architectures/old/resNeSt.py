...
#     Zhang, Hang; Wu, Chongruo; Zhang, Zhongyue;     #
#     Zhu, Yi; Zhang, Zhi; Lin, Haibin; Sun, Yue;     #
#    He, Tong; Muller, Jonas; Manmatha, R.; Li, Mu;   #
#                  Smola, Alexander.                  #
...
"""
class Architecture_ResNeSt(Abstract_Architecture):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    def __init__(self, fixed_input_shape, dropout=False,
    ...
    def create_model_2D(self, input_shape, n_labels=2):
        ...
        resnest_architecture = ResNest(verbose=False,
...
#-----------------------------------------------------#
#        ResNeSt3D TensorFlow 2 Implementation        #
#-----------------------------------------------------#
#                      Reference                      #
# https://github.com/QiaoranC/tf_ResNeSt_RegNet_model #
#-----------------------------------------------------#
