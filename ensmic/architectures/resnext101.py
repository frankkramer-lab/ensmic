...
#-----------------------------------------------------#
#             Architecture class: ResNeXt             #
#-----------------------------------------------------#
""" The classification variant of the ResNeXt101 architecture.

Methods:
    __init__                Object creation function
    create_model_2D:        Creating the 2D ResNeXt model for classification
    create_model_3D:        -
"""
class Architecture_ResNeXt101(Abstract_Architecture):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    def __init__(self, channels, input_shape=(224, 224),
        ...
        self.normalization_mode = "torch"

    #---------------------------------------------#
    #               Create 2D Model               #
    #---------------------------------------------#
    def create_model_2D(self, input_shape, n_labels=2):
        # Obtain ResNeXt as base model
        base_model = ResNeXt101(include_top=False, weights=self.weights,
                                input_tensor=None,
